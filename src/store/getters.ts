export default {
  ...
  videoTab: (state) => { return state.video.videoTab },
  ...
  mvData: (state) => { return state.video.mvData },
  mvPageNum: (state) => { return state.video.mvPageNum },
  mvTotal: (state) => { return state.video.mvTotal },
